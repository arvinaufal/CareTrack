...
export default function PatientPage() {
    ...
    const getPatient = async () => {
        ...
        const endpoint = `http://127.0.0.1:3000/api/patients?search=${searchKeyword}&perPage=${perPage}&page=${page}`;
    ...
    const downloadReport = async () => {
        ...
        try {
            ...
            const endpoint = `http://127.0.0.1:3000/api/export/excel?search=${searchKeyword}`;
            ...
            link.setAttribute('download', `patients_report.${extension}`);
    ...
    const columns = [
        ...
        },
        {
            ...
            selector: row => row.totalTreatments,
            sortable: true,
        },
        {
            name: 'Total Medicines',
            selector: row => row.totalMedicines,
            sortable: true,
        },
        {
            name: "Total Cost",
            ...
            <div className="flex flex-col w-5/6 bg-slate-100 px-6 py-4 gap-4">
                <div className="flex flex-row w-full rounded-xl shadow-xl bg-white px-4 py-4">
                    <div className="flex w-1/2 items-center content-center gap-4 flex-row">
                        ...
                        <span className="text-xl font-semibold text-[#fc84ac]">Patients</span>
                    </div>
